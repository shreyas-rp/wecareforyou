...
/**
 * Built-in reference catalogs. The case study referred to an external Excel
 * file for medicines / medical tests and a specialization list; that file was
 * not provided, so these sensible defaults are seeded instead and can be
 * extended via the admin/data layer later.
 */
