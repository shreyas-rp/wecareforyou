...
// ---- Public-ish search (any authenticated user, used by patients) ----
...
// Doctor acts on a specific appointment.
router.put(
...
router.put(
  ...
  [
    ...
    body('prescriptions')
      .optional()
      .isArray()
      .withMessage('Prescriptions must be a list.'),
    ...
    body('prescriptions.*.timing')
      .optional()
      .isIn(['AF', 'BF'])
      .withMessage('Timing must be AF or BF.'),
  ],
  validate,
